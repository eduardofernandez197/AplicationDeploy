...
public class ObservacaoController {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> excluirPorId(@PathVariable Long ocorrenciaId, @PathVariable Long id) {
        service.excluirPorId(ocorrenciaId, id);

        return ResponseEntity.noContent().build();
    }

    @DeleteMapping("/{id}/fotos/{fotoId}")
    public ResponseEntity<Void> excluirFotoPorId(@PathVariable Long ocorrenciaId, @PathVariable Long id,
            @PathVariable Long fotoId) {
        service.excluirFotoPorId(ocorrenciaId, id, fotoId);
